...
const CountDown = () => {
    ...
    return (
        <div className="p-4 space-y-3">
            ...
            >
                <h2 className="text-2xl font-bold mb-2">Registration Opening Soon</h2>
            </motion.div>
            ...
            <motion.div
                ...
                className="text-center"
            >
                <h2 className="text-lg font-bold mb-2">On 8th and 9th Dec</h2>
            ...
            <div className="w-full text-center relative overflow-hidden">
                <AnimatePresence mode="popLayout">
                    <motion.span
                        ...
                        className="block text-2xl md:text-4xl lg:text-6xl xl:text-7xl text-violet-700 font-medium"
                    >
                        {num}
                    </motion.span>
                </AnimatePresence>
